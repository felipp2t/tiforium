...
test("it should cancel all cards of pile of the same value", () => {
  const pile = createPile({
    cardsPlayed: [
      {
        playerId: "c6f72f1d-ef12-4d84-9e52-2b8321f8b10e",
...
beforeAll(() => {
  ...
  card5 = getCard({ value: "1", suit: "SPADES" });
  card6 = getCard({ value: "2", suit: "HEARTS" });
  card7 = getCard({ value: "2", suit: "DIAMONDS" });
  card8 = getCard({ value: "1", suit: "HEARTS" });
});
